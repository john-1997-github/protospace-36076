...
ActiveRecord::Schema.define(version: 2021_07_13_093122) do
  ...
  create_table "commnets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "text", null: false
    t.bigint "user_id", null: false
    t.bigint "prototype_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["prototype_id"], name: "index_commnets_on_prototype_id"
  ...
  add_foreign_key "commnets", "prototypes"
